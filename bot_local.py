...
def send_about(message):
    ...
    with open('template_text/about.txt', mode='r', encoding='utf-8') as f:
        ...
        about = temp.substitute(
            STUDENT_NAME = 'Rangga Gemilang Maulana',
            BATCH_ACADEMY = 'Sparta',
            GITHUB_REPO_LINK = 'https://github.com/RanggaGemilang?tab=repositories'
        )
...
def send_plot(message):
    ...
    if selected_campaign_id in unique_campaign:
        ...
        axes[1].set_ylabel('Approved Conversion', fontsize=8)
        ...
        plot_info = list(zip(
            [f'total {df_plot.columns.values[0]}', f'total {df_plot.columns.values[1]}', f'average {df_plot.columns.values[2]}'],
            df_plot.idxmax(),
            df_plot.idxmin()))
